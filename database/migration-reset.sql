-- ========================================
-- SCRIPT DE MIGRAÇÃO - RADAR DO BAIRRO
-- ========================================
-- Este script limpa tudo e recria o banco de dados do zero
-- ATENÇÃO: Isso vai APAGAR TODOS OS DADOS!
-- Use apenas em desenvolvimento ou quando quiser resetar

-- 1. Dropar Views (dependem das tabelas)
...
-- 4. Dropar Tabelas (na ordem correta devido às foreign keys)
