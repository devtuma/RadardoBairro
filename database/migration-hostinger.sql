...
-- ========================================
-- Versão para Hostinger (sem comandos SUPER)
...
-- ========================================
-- CRIAR EVENT (pode falhar se não tiver permissão)
-- ========================================
...
SELECT 'Migração concluída com sucesso!' as status,
       (SELECT COUNT(*) FROM posts) as posts_criados,
       (SELECT COUNT(*) FROM post_comments) as comentarios_criados,
       (SELECT COUNT(*) FROM votes) as votos_criados;
